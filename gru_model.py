...
def gru_forecast(time_series_data, time_step, epochs, batch_size):
    """
    Fit a GRU model and return predictions.
    
    Parameters:
    - time_series_data: Pandas DataFrame with 'SP500' column.
    - time_step: Number of timesteps for the GRU input.
    - epochs: Number of training epochs for the GRU.
    - batch_size: Batch size for training the GRU.

    Returns:
    - Test predictions from the GRU model (inverse scaled).
